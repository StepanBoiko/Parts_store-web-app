...
public class ProductInfoRepositoryImpl {
    ...
    public HomeTabsDataResponse getBrandsAndApparelsByGender() {
        ...
        homeTabsDataResponse.setEngine(getBrandsAndApparelsList(1));
        homeTabsDataResponse.setTransmission(getBrandsAndApparelsList(2));
        homeTabsDataResponse.setBody(getBrandsAndApparelsList(3));
        homeTabsDataResponse.setExhaust(getBrandsAndApparelsList(4));
        homeTabsDataResponse.setBrake(getBrandsAndApparelsList(5));
        homeTabsDataResponse.setSuspension(getBrandsAndApparelsList(6));
